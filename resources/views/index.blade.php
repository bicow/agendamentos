        ...
        <div class="bg-white">
            ...
            <main class="bg-white px-4 py-3">
                <form action="/" method="POST">
                    ...
                    <input type="text" id="name" name="nome" placeholder="Digite seu nome" class="mb-3 form-control">

                    <label for="phone" class="d-block mb-2">Telefone:</label>
                    <input type="text" id="phone" name="telefone" placeholder="(xx)xxxxx-xxxx" class="mb-3 form-control">
                    ...
                    <input type="date" id="contact" name="data_contato" class="mb-3 form-control">

                    <label for="obs" class="d-block mb-2">Observação:</label>
                    <textarea name="observacao" id="obs" rows="5" class="form-control"></textarea>
